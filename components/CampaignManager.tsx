      ...
      <div className="row">
          <div className="col s12">
              <ul className="tabs tabs-fixed-width glass-panel" ref={tabsRef} style={{borderRadius: '50px', height: '50px', overflow: 'hidden'}}>
                  ...
                  <li className="tab col s3"><a href="#lab" className={activeTab==='LAB'?'active':''} onClick={() => setActiveTab('LAB')}><Cpu size={14} style={{verticalAlign: 'middle', marginRight: '6px'}}/> AI Lab</a></li>
          ...
          <div className="row">
              <div className="col s12 l6">
                  <div className="card-panel glass-panel">
                      <h5 className="white-text mb-4" style={{fontWeight: 700}}><Zap size={22} className="orange-text" style={{verticalAlign: 'bottom'}}/> Generator Core</h5>
