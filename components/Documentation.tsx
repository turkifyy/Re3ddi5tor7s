...
import { BookOpen, ShieldCheck, Link, AlertTriangle, Cpu, ChevronRight } from 'lucide-react';
        ...
        <div className="row">
            ...
            <div className="col s12">
                 <ul className="collection with-header border-none" style={{border: 'none'}}>
                    ...
                    <li className="collection-item blue-grey darken-3 white-text">
                        3. Copy Client ID and Secret to Settings <ChevronRight size={14} style={{verticalAlign: 'middle', display: 'inline'}} /> Credential Pool.
                    </li>
                 </ul>
            </div>
