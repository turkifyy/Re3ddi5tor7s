      ...
      <div className="grid grid-cols-1 gap-6">
          ...
          <div className="glass-panel rounded-2xl p-8 border border-white/5">
              ...
              <div className="space-y-4 text-slate-300 text-sm leading-relaxed">
                  ...
                  <p>
                      بعد الحصول على المفاتيح، انتقل إلى <span className="text-white font-bold">الإعدادات</span> &rarr; <span className="text-white font-bold">Reddit Account Linking</span> وأضف البيانات.
