                    ...
                    <div className="card-content white-text">
                        ...
                        <ul className="collection" style={{border: 'none'}}>
                            ...
                            <li className="collection-item avatar valign-wrapper pl-0">
                                ...
                                <div style={{marginLeft: '15px'}}>
                                    <span className="title font-bold">DeepSeek AI</span>
                                    <p className="grey-text text-lighten-1" style={{fontSize: '0.8rem'}}>{serviceHealth.deepseek === 100 ? 'Neural Link Active' : 'API Key Missing'}</p>
                                </div>
                            </li>
                             <li className="collection-item avatar valign-wrapper pl-0">
