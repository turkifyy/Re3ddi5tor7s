...
export const TerminalLog: React.FC = memo(() => {
  ...
  return (
    <div className="bg-dark bg-opacity-75 border border-secondary border-opacity-25 shadow-lg d-flex flex-column" style={{height: '200px', width: '100%'}} dir="ltr">
        <div className="bg-black bg-opacity-50 px-3 py-1 d-flex justify-content-between align-items-center border-bottom border-secondary border-opacity-25">
             <span className="text-secondary font-monospace" style={{fontSize: '0.75rem'}}>SYSTEM_KERNEL_V6.2</span>
