...
import { LayoutDashboard, Users, Target, Terminal, Settings, LogOut, Cpu, Radio, Menu, X, ShieldCheck, User, MessageCircle, Book, Search, WifiOff } from 'lucide-react';
                ...
                <div>
                   ...
                   <div className="flex items-center gap-2 mt-1.5">
                       ...
                       <span className={`text-[10px] font-mono tracking-[0.2em] ${isOnline ? 'text-primary-500/80' : 'text-red-500'}`}>
                           {isOnline ? 'متصل_V5.0' : 'فقد الاتصال'}
                       </span>
                   </div>
                </div>
            </div>
